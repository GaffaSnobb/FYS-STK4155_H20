...
class _StatTools:
    ...
    def regression_with_sklearn(self,epochs,step,alpha=0):
        if alpha == 0:
            S = SGDRegressor(max_iter=epochs,penalty=None,eta0=step)
        else:
            S = SGDRegressor(max_iter=epochs,alpha=alpha,eta0=step)
